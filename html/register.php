				...
				<div class="form-popup" id="myForm">
					<form method="post" action="register.php" class="form-container">
						<div id="div_login">
							...
							<input type="text" class="textbox" id="email" name="email" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="The email format is invalid" required>
							<label for="psw">
								<b>Password</b>
							</label>
							<input type="password" class="textbox" id="password" name="password" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
