				...
				<div class="form-popup" id="myForm">
					<form method="post" action="" class="form-container"><!-- All of forms are method=post for sending data into php scripts by id or name of input  -->
						...
						<div id="div_login">
							...
							<input type="text" class="textbox" id="txt_uname" name="txt_uname" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="The email format is invalid"required>
							<label for="psw">
								<b>Password</b>
							</label>
					...
					<p><a href="http://localhost/teste_isw/ReviewChan/html/index2.php">Login via Guest Mode here. 
					</a></p>
								</p>
